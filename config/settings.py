...
INSTALLED_APPS = [
    ...
    'cloudinary_storage',  # For cloud image storage
    'cloudinary',
...
# Database - Support both MySQL (local) and PostgreSQL (Render)
...
if DEBUG:
    ...
    # Cloudinary for production (Render)
...
# Cloudinary Configuration (for image storage in production)
CLOUDINARY_STORAGE = {
